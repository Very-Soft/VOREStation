...
#define Z_LEVEL_GB_BOTTOM  					6
#define Z_LEVEL_GB_MIDDLE  					7
#define Z_LEVEL_GB_TOP     					8

#define Z_LEVEL_SHIP_LOW					9
#define Z_LEVEL_SHIP_MID					10
#define Z_LEVEL_SHIP_HIGH					11

#define Z_LEVEL_SURFACE_MINE				12
#define Z_LEVEL_SOLARS						13
#define Z_LEVEL_CENTCOM						14
#define Z_LEVEL_MISC						15
#define Z_LEVEL_UNDERDARK					16
#define Z_LEVEL_PLAINS						17
