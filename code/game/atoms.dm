...
// TODO - Evaluate if this should be on /atom/New() or /atom/movable/New() ~ Leshana
// This is declared on /atom/movable instead of /atom in an effort to avoid having /New() on turfs.
/atom/New()
...
// Note: I removed "auto_init" feature (letting types disable auto-init) since it shouldn't be needed.
